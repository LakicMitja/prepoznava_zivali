...
# Pregledamo, ali deluje cuda, za učenje s pomočjo GPU
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            for inputs, labels in dataloaders[phase]:
                ...
                # Forward
                # spremljanje zgodovine, če učimo
...
model_ft.load_state_dict(torch.load('./zivali_resnet.pth'))

# Prepoznava ene živali z loadanim modelom
